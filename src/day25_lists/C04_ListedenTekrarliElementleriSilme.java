...
public class C04_ListedenTekrarliElementleriSilme {
    public static void main(String[] args) {
        // verilen bir listeden tekrar eden sayıları sadece 1 kere yazdıran bir method oluşturun.
    ...
    public static void tekrarsizListeOlustur(List<Integer> sayilar) {
        ...
        for (int i = 0; i < sayilar.size() ; i++) {
            if (!tekrarsizList.contains(sayilar.get(i))){ // terkrarsız liste contains in içindeki içermiyorsa
